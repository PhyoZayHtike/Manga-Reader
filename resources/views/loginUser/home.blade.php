...
@section('main')
                    ...
                    <div class="col-12 col-md-4 col-xl-3 col-xxl-3 mb-4 mt-4">
                        <div class="row">
                            <div class="col-4 col-md-10 col-lg-8 col-xxl-9 zoom">
                                <a href="{{ route('loginUser#detail', $d->id) }}"><img
                            ...
                            <div class="col-7 col-md-12 col-lg-10 col-xxl-10 mt-2">
                                <a class="text-black link-underline-opacity-0 h5"
                                    ...
                                    href="{{ route('loginUser#detail', $d->id) }}"><span
                                    ...
                                    <div class="col-11 col-xxl-11">
                                        <div class="d-flex justify-content-between mt-2">
                                            ...
                                            @if ($lastChapter)
                                                <a class="btn btn-sm btn-light border shadow-sm fw-medium text-muted rounded-4"
                                                    href="{{ route('loginUser#view', ['chapterId' => $d->id, 'chapterNumber' => $lastChapter->chapter_number]) }}">
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                           {{--first chapter --}}
                                             ...
                                             @if ($firstChapter)
                                                     <a class="btn btn-sm btn-light border shadow-sm fw-medium text-muted rounded-4" href="{{ route('loginUser#view', ['chapterId' => $d->id, 'chapterNumber' => $firstChapter->chapter_number]) }}">
    ...
    <div style="height: 60vh" class="wrapper d-flex align-items-center justify-content-center">
        <h1 class="h1 typing-demo mt-5 mb-5 fw-bold">
            Manga Not Found!
        </h1>
     </div>
    @endif
